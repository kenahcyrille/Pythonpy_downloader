...
def yum_makecache():
    """Run 'yum makecache' to update the package cache."""
...
def main():
    ...
    parser.add_argument("--service", help="Name of the service to restart after downloading packages.")
    parser.add_argument("--makecache", action="store_true", help="Run 'yum makecache' after downloading packages.")
    ...
    if downloaded_packages:
        ...
        # Run 'yum makecache' if specified
        if args.makecache:
            print("Running 'yum makecache'")
            yum_makecache()
